...
export default function DualAxisBarLineChartRenderer({ rows, cfg, rtl, measureFmt, measure2Fmt, plotW, plotH, broadcasts, onClickPoint }: ChartRendererProps) {
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      <ComposedChart data={rows} margin={chartMargin(rtl, { top: 4, right: 8, bottom: 20, left: 0 })}
        ...
        {hasSecond && (<Line yAxisId="right" type="monotone" dataKey="value2" name={cfg.measure2 ?? 'value2'} stroke="#fbbf24" strokeWidth={2} strokeDasharray={seriesDash(1, cfg.series_patterns)} dot={{ r: 3 }}>
