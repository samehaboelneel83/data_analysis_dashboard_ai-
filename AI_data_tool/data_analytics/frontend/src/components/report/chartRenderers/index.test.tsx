...
describe('CHART_RENDERERS registry', () => {
  ...
  it('has area chart registered', () => {
    expect(Object.keys(CHART_RENDERERS)).toContain('area')
  })

  it('has funnel chart registered', () => {
    expect(Object.keys(CHART_RENDERERS)).toContain('funnel')
  })

  it('has ribbon chart registered', () => {
    expect(Object.keys(CHART_RENDERERS)).toContain('ribbon')
  })
